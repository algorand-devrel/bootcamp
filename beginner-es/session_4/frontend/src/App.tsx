          ...
          <div className="hero-content text-center rounded-lg p-6 max-w-md bg-white mx-auto">
            <div className="max-w-md">
              ...
              <div className="grid">
                ...
                {activeAddress && appID > 0 && auctionState === AuctionState.Ended && (
                  <AppCalls appID={appID} method="claim_asset" setAuctionState={setAuctionState} />
                )}

                {activeAddress && appID > 0 && auctionState === AuctionState.Ended && (
                  <AppCalls appID={appID} method="claim_bid" setAuctionState={setAuctionState} />
                )}
