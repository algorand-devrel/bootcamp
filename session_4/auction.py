...
class Auction(Application):
    ...
    highest_bidder: Final[ApplicationStateValue] = ApplicationStateValue(stack_type=TealType.bytes, default=Bytes(""))
    ...
    @external(authorize=Authorize.only(APP_CREATOR))
    def start_auction(self, starting_price: abi.Uint64, length: abi.Uint64, axfer: abi.AssetTransferTransaction):
        return Seq(
